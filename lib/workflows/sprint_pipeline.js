...
function treeIdentityFailed(story, impl, verify) {
  return makeSprintStoryReturn({
    storySlug: story.slug,
    branch: impl.branch,
    commits: impl.commits,
    ...treeIdentityFailure({
      ...
      detail: verify.treeIdentityFailure,
    }),
  })
}
...
async function runStoryChain(story, isolation) {
  ...
  if (verify.treeIdentityFailure) return treeIdentityFailed(story, impl, verify)
